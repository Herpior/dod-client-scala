...
class ExportTest extends FlatSpec with Matchers {
  ...
  "DoodleModel.toDodPostJsonStrokes" should "return correctly rounded string" in {
  ...
  "LayerList.toJsonString" should "return correctly rounded string" in {
    val doodleModel = new DoodleModel
    val layerList = doodleModel.layers
  ...
  "LayerList.toShortJsonString" should "return correctly rounded string" in {
    val doodleModel = new DoodleModel
    val layerList = doodleModel.layers
