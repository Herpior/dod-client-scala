...
trait BasicTool {
  ...
  def getConfigSetters():Array[Double=>Unit] = Array() //TODO: make this work with non-double config values
  def getConfigNames():Array[String] = Array()
  def getConfigValues():Array[Double] = Array()
